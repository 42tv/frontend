...
import BookmarkContent from '@/app/follow/components/BookmarkContent'; // BookmarkContent 임포트
import FanContent from '@/app/follow/components/FanContent'; // FanContent 임포트
