    ...
    return (
        <div className="grid grid-cols-6">
            <div className="flex col-span-1 text-center items-center">
                <label className="w-[100px]" style={{ color: 'var(--text-100)' }}>비밀번호</label>
            </div>
            <div className="flex col-span-5 items-center h-[40px]">
                ...
                <div className="flex col-span-4 items-center ml-4 space-x-2 h-full">
                    {isPrivate ? (
                        <div className="flex h-[40px] items-center px-2 py-1 rounded-md" style={{ border: '1px solid var(--bg-300)', backgroundColor: 'var(--bg-300)' }}>
                            <input 
                                type="text"
                                value={password}
